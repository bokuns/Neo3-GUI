 ...
 */
export const toAddress = (scriptHashHex) => {
 ...
 * @param {*} hexString
 */
export const toBase64String = (hexString) => {
 ...
 * @param {*} hexString
 */
export const toUtf8String = (hexString) => {
 ...
 * @param {*} text
 */
export const fromUtf8String = (text) => {
 ...
 * @param {*} hexString
 */
export const toBigInt = (hexString) => {
